...
## <HoverUnderline>What is Sorting?</HoverUnderline>
...
#### <HoverUnderline>Key Steps in Most Sorting Algorithms</HoverUnderline>
...
- [Selection Sort (Grokking Algorithms)](https://edu.anarcho-copy.org/Algorithm/grokking-algorithms-illustrated-programmers-curious.pdf#page=40)
- [Quick Sort (Grokking Algorithms)](https://edu.anarcho-copy.org/Algorithm/grokking-algorithms-illustrated-programmers-curious.pdf#page=70)
- [Making Sense of Merge Sort](https://medium.com/basecs/making-sense-of-merge-sort-part-1-49649a143478)
